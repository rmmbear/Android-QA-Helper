...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.device_display.addTab(self.installed_apps, "")
    ...
    def retranslateUi(self, Form):
        ...
        self.device_display.setTabText(self.device_display.indexOf(self.installed_apps), _translate("Form", "Installed Apps"))
